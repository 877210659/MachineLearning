...
def logistic_regression2(filename):
    # 引入数据文件
    print("plotting data...\n")
    ...
    print(' 0.0085\n 0.0188\n 0.0001\n 0.0503\n 0.0115\n');
    # 使用高级优化算法
    result = op.minimize(fun=cost_function_reg, x0=initial_theta.flatten(), args=(x, y,lamb), method='TNC', jac=gradient_reg)
    print(result)
    theta = result.x
...
logistic_regression2("ex2data2.txt")
